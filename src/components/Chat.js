...
const Chat = ({ selectedUser, currentUserId, socket }) => {
    ...
    const handleScroll = () => {
        ...
        setShowScrollButton(messagesEndRef.current.getBoundingClientRect().bottom < window.innerHeight);
    };
    ...
    return (
        <div className="chat-container">
            ...
            <div className="chat-input">
                ...
                <input id="file-upload" type="file" accept="*" onChange={handleFileChange} ref={fileInputRef} />

                {preview && <img src={preview} alt="Preview" className="preview-img" width={30} height={30}/>}
                
                {selectedFile && !preview && <p className="file-name">📎 {selectedFile.name}</p>}
